...
UI_STRINGS: Dict[str, Dict[str, str]] = {
    ...
    'ru': {
        ...
        'lang_selection_title': 'Выбор языка',
        'lang_selection_subtitle': 'Выберите предпочтительный язык для интерфейса настроек.',
        'faq_panel_subtitle': 'Помощь по типичным проблемам и конфигурации.',
        'faq_action_validate_all': 'Проверить все API ключи',
        'faq_action_system_status': 'Проверить состояние системы',
        'press_enter_continue': 'Нажмите Enter для продолжения...',
        'validating_api_keys_panel': 'Проверка API ключей...',
        'api_key_validation_table_title': 'Результаты проверки API ключей',
        'table_col_api_key': 'API ключ',
        'table_col_status': 'Статус',
        'table_col_message': 'Сообщение',
        'status_valid': 'Действителен',
        'status_invalid': 'Недействителен',
        'status_not_set': 'Не задан',
        'status_error': 'Ошибка',
        'checking_system_status': 'Проверка состояния системы...',
        'network_ok': 'Сетевое подключение в норме',
        'network_issues': 'Проблемы с сетью: {message}',
        'available_models_label': 'Доступные модели',
        'and_n_more': '... и ещё {n}',
        'ollama_status_prefix': 'Ollama: {message}',
        'api_keys_summary': 'API ключи: {valid_count}/{set_count} действительны, {not_cfg} не настроены',
        'faq_content_unavailable': 'Содержимое FAQ недоступно.',
        'no_faq_for_topic': "Нет содержимого FAQ для темы '{topic}'.",
        'check_status_line': 'Статус: {value}',
        'fix_prefix': 'Исправление: {text}',
        'live_status_check': 'Проверка статуса в реальном времени',
        'suggestions_header': 'Рекомендации',
        'setup_steps_header': 'Шаги настройки',
        'current_configuration_header': 'Текущая конфигурация',
        'related_commands_header': 'Связанные команды',
        'environment_variables_header': 'Переменные среды',
        'var_current_line': 'Текущее: {value}',
        'common_issues_header': 'Типичные проблемы',
        'label_status': 'Статус',
        'value_set_masked': 'Задано ({masked})',
        'configuration_cancelled': 'Настройка отменена.',
        'mode_cli': 'Режим CLI',
        'mode_tui': 'Режим TUI',
        'settings_footer_hint': 'Нажмите Ctrl+C для отмены | Переменные: {n_vars} | Категории: {n_cats}',
        'change_language': 'Сменить язык',
        'select_variable_from_category': "Выберите переменную из '{category}':",
        'add_new_api_key_choice': '[+ Добавить новый API ключ]',
        'back_to_categories': '[Назад к категориям]',
        'no_vars_in_category': "Нет настраиваемых переменных в '{category}'.",
        'what_to_do_with_var': 'Что вы хотите сделать с {var}?',
        'action_edit_value': 'Изменить значение',
        'action_delete_key': 'Удалить API ключ',
        'add_new_api_key_title': 'Добавить новый API ключ',
        'add_new_api_key_intro': (
            'Формат: PROVIDER_API_KEY\n'
            'Примеры: ANTHROPIC_API_KEY, GOOGLE_API_KEY, MISTRAL_API_KEY\n\n'
            'Имя должно быть в ВЕРХНЕМ РЕГИСТРЕ и заканчиваться на _API_KEY'
        ),
        'enter_api_key_name': 'Введите имя API ключа:',
        'err_api_key_name_empty': 'Имя API ключа не может быть пустым',
        'err_api_key_name_format': (
            'Неверный формат. Используйте ВЕРХНИЙ РЕГИСТР и заканчивайте на _API_KEY (например, ANTHROPIC_API_KEY)'
        ),
        'err_api_key_exists': "API ключ '{name}' уже существует. Используйте параметр редактирования для его изменения.",
        'enter_api_key_value': 'Введите значение для {name}:',
        'err_api_key_value_empty': 'Значение API ключа не может быть пустым',
        'api_key_added_body': 'Значение: {masked}\n\nИзменения сохранены в .env и активны в текущей сессии.',
        'api_key_added_title': 'API ключ {name} успешно добавлен.',
        'variable_updated_title': 'Переменная {name} успешно обновлена.',
        'variable_updated_body': 'Новое значение: {value}\n\nИзменения сохранены в .env и активны в текущей сессии.',
        'configure_another_in_category': "Настроить другую переменную в '{category}'?",
        'delete_api_key_title': 'Удалить API ключ',
        'delete_api_key_irreversible': 'Это действие необратимо.',
        'delete_api_key_confirm': 'Вы уверены, что хотите удалить {name}?',
        'api_key_deleted_title': 'API ключ {name} успешно удалён.',
        'api_key_deleted_body': 'Изменения сохранены в .env и удалены из текущей сессии.',
        'failed_delete_api_key': 'Не удалось удалить API ключ.',
        'faq_module_unavailable': 'Модуль FAQ недоступен. Установите необходимые зависимости.',
        'generic_error': 'Ошибка: {message}',
        'hint_not_set_suffix': ' (не задано)',
        'hint_current_masked': ' (текущее: {masked})',
        'hint_current_plain': ' (текущее: {value})',
        'choice_value_not_set': '(не задано)',
        'choice_value_masked': '{masked}',
        'tui_settings_title': 'Настройки CAI',
        'tui_interactive_unavailable': 'Интерактивный режим недоступен в TUI.',
        'tui_use_commands_below': 'Используйте команды ниже для настройки.',
        'tui_quick_commands': 'Быстрые команды настройки',
        'tui_current_configuration': 'Текущая конфигурация',
        'tui_api_keys_status': 'Статус API ключей',
        'tui_tip_env': 'Подсказка: используйте /env set ИМЯ значение для изменения любой настройки каталога',
        'tui_label_model': 'Модель',
        'tui_label_agent_type': 'Тип агента',
        'tui_label_debug': 'Уровень отладки',
        'tui_label_stream': 'Потоковая передача LLM',
        'tui_label_tool_stream': 'Потоковая передача инструментов',
        'tui_label_compacted_memory': 'Сжатая память',
        'tui_label_tracing': 'Трассировка',
        'tui_value_set': 'Задано',
        'tui_value_not_set': 'Не задано',
        'tui_cmd_list': 'Вывести все настраиваемые переменные',
        'tui_cmd_get': 'Показать текущее значение переменной каталога',
        'tui_cmd_set': 'Установить переменную каталога',
        'tui_cmd_model': 'Изменить текущую модель',
        'tui_cmd_settings_status': 'Показать состояние системы',
        'tui_cmd_settings_validate': 'Проверить API ключи',
        'prompt_type_to_search_accept': '(Введите для поиска или нажмите Enter для принятия текущего значения)',
        'prompt_type_to_search_empty_default': '(Введите для поиска или оставьте пустым для значения по умолчанию)',
        'prompt_enter_temperature': 'Введите температуру (0.0-2.0):',
        'prompt_enter_top_p': 'Введите top_p (0.0-1.0):',
        'prompt_enter_max_turns': "Введите максимальное количество ходов (число или 'inf'):",
        'prompt_enter_price_limit': 'Введите лимит стоимости в долларах (например, 2.5):',
        'prompt_enter_timeout_seconds': 'Введите тайм-аут в секундах:',
        'prompt_enter_interval_turns': 'Введите интервал (количество ходов):',
        'prompt_enter_port': 'Введите номер порта (1-65535):',
        'prompt_enter_workers': 'Введите количество воркеров:',
        'prompt_enter_ollama_base': 'Введите базовый URL API Ollama:',
        'choice_custom_value': 'Пользовательское значение...',
        'choice_custom_amount': 'Пользовательская сумма...',
        'choice_custom_port': 'Пользовательский порт...',
        'choice_custom_url': 'Пользовательский URL...',
        'err_model_not_found': "Модель '{name}' не найдена.",
        'err_agent_not_found': (
            "Агент '{name}' не найден. Выберите из доступных агентов или введите для поиска."
        ),
        'validation_module_unavailable': 'Модуль проверки недоступен.',
        'status_module_unavailable': 'Модуль состояния недоступен.',
        'unknown_settings_subcommand': 'Неизвестная подкоманда: {name}',
        'available_subcommands_header': 'Доступные подкоманды:',
        'ollama_sugg_serve': "Запустите 'ollama serve' в терминале",
        'ollama_sugg_firewall': 'Проверьте, не блокирован ли порт 11434 файрволом',
        'ollama_sugg_api_base': 'Убедитесь, что OLLAMA_API_BASE указывает на ваш сервер Ollama',
    },
...
FAQ_CONTENT: Dict[str, Dict[str, Dict[str, Any]]] = {
    ...
    'ru': {
        'api_keys': {
            'title': 'Устранение неполадок API ключей',
            'description': 'Типичные проблемы с API ключами и способы их решения',
            'related_commands': [
                {'command': '/env', 'description': 'Переменные среды и API ключи'},
                {'command': '/settings validate', 'description': 'Проверка API ключей'},
                {'command': '/model', 'description': 'Сменить текущую модель (требуется действительный API ключ)'},
            ],
            'checks': [
                {
                    ...
                    'validation_url': 'https://api.openai.com/v1/models',
                    'common_issues': [
                        'Ключ начинается с sk-, но истёк',
                        'Недостаточно квоты/кредитов',
                        'Ключ от другой организации',
                        'Превышен лимит запросов',
                    ],
                    'solutions': [
                        'Проверьте панель OpenAI на https://platform.openai.com',
                        'Убедитесь, что биллинг настроен правильно',
                        'Проверьте разрешения API ключа',
                        'Дождитесь сброса лимита запросов или обновите тариф',
                    ],
                },
                {
                ...
                },
                {
                    ...
                    'solutions': [
                        'Свяжитесь с Alias Robotics для получения действительного ключа',
        ...
        'ollama': {
            'title': 'Устранение неполадок Ollama / локальных моделей',
            'description': 'Настройка и устранение неполадок Ollama для локального вывода моделей',
            'related_commands': [
                {'command': '/model ollama/llama3.2', 'description': 'Переключиться на модель Ollama'},
                {'command': '/settings ollama', 'description': 'Руководство по настройке Ollama'},
                {'command': '/env set OLLAMA', 'description': 'Настроить переменные среды Ollama'},
            ],
            'steps': [
                {
                    'step': 1,
                    'title': 'Проверить установку Ollama',
                    'command': 'ollama --version',
                    'expected': 'Должен отобразиться номер версии',
                    'fix': 'Установите с https://ollama.com/download',
                },
                {
                    'step': 2,
                    'title': 'Запустить сервер Ollama',
                    'command': 'ollama serve',
                    'expected': 'Сервер запускается на порту 11434',
                    'fix': 'Запустите ollama serve в терминале',
                    'note': 'НЕ используйте "ollama run" — это запускает модели только в CLI',
                },
                {
                    'step': 3,
                    'title': 'Проверить, что сервер работает',
                    'command': 'curl http://127.0.0.1:11434',
                    'expected': 'Должен вернуть "Ollama is running"',
                    'fix': 'Проверьте, не блокирован ли порт 11434 файрволом',
                },
                {
                    'step': 4,
                    'title': 'Загрузить модель',
                    'command': 'ollama pull llama3.2',
                    'expected': 'Модель успешно загружается',
                    'fix': 'Проверьте дисковое пространство и подключение к интернету',
                },
                {
                    'step': 5,
                    'title': 'Настроить CAI',
            ...
            'docker_notes': {
                'title': 'Конфигурация для Docker',
                'description': 'При запуске CAI в Docker, localhost ссылается на контейнер, а не на хост',
                'solutions': {
                    'Windows/macOS': 'Используйте host.docker.internal:11434',
                    'Linux': 'Используйте 172.17.0.1:11434 или IP вашего хоста',
                },
            },
            'common_models': [
                'ollama/llama3.2',
        ...
        'streaming': {
            'title': 'Настройка потоковой передачи',
            'description': 'Понимание параметров потоковой передачи CAI',
            'related_commands': [
                {'command': '/env set CAI_STREAM', 'description': 'Переключить потоковую передачу LLM'},
                {'command': '/env set CAI_TOOL_STREAM', 'description': 'Переключить потоковую передачу вывода инструментов'},
            ],
            'variables': {
                'CAI_STREAM': {
                    'description': 'Управляет потоковой передачей вывода LLM (по токенам)',
                    'values': {'true': 'Видеть токены по мере генерации', 'false': 'Ждать полного ответа'},
                    'default': 'false',
                },
                'CAI_TOOL_STREAM': {
                    'description': 'Управляет потоковой передачей вывода инструментов (вывод команд в реальном времени)',
                    'values': {'true': 'Видеть вывод по мере выполнения', 'false': 'Ждать завершения команды'},
                    'default': 'true',
                },
            },
            'note': 'Эти параметры независимы — можно включить один без другого',
        },

        'parallel': {
            'title': 'Устранение неполадок параллельного выполнения',
            'description': 'Проблемы с запуском нескольких агентов параллельно',
            'related_commands': [
                {'command': '/parallel', 'description': 'Запуск параллельного выполнения агентов'},
                {'command': '/env set CAI_PARALLEL', 'description': 'Установить количество параллельных агентов'},
                {'command': '/env set CAI_PARALLEL_AGENTS', 'description': 'Указать имена агентов для параллельного режима'},
            ],
            'variables': {
                'CAI_PARALLEL': 'Количество параллельных экземпляров (1-20)',
                'CAI_PARALLEL_AGENTS': 'Имена агентов через запятую',
                'CAI_AUTO_RUN_PARALLEL': 'Автозапуск параллельных агентов',
            },
            'common_issues': [
                {
                    'issue': 'Агенты разделяют историю сообщений',
                    'cause': 'Изоляция экземпляров не работает',
                    'fix': 'Каждый параллельный агент должен иметь уникальный ID экземпляра',
                },
                {
                    'issue': 'Ошибки ограничения частоты запросов',
                    'cause': 'Слишком много параллельных запросов к API',
                    'fix': 'Уменьшите CAI_PARALLEL или добавьте задержки',
                },
            ],
        },

        'memory': {
            'title': 'Устранение неполадок сжатой памяти',
            'description': 'Сводки сессий из /compact, встраиваемые в промпты агентов',
            'related_commands': [
                {'command': '/memory status', 'description': 'Проверить сохранённые сжатые сводки'},
                {'command': '/compact', 'description': 'Сжать разговор в сводку'},
                {'command': '/env set CAI_COMPACTED_MEMORY', 'description': 'Включить (true) или выключить (false) встраивание в промпт'},
            ],
            'requirements': [],
            'variables': {
                'CAI_COMPACTED_MEMORY': 'true/false — встраивать сводки /compact в системные промпты',
            },
            'setup_steps': [
                'Выполните /compact (или сжатие в TUI) для создания сводки',
                'Установите CAI_COMPACTED_MEMORY=true, чтобы новые агенты загружали сводку в свой промпт',
            ],
        },

        'tui': {
            'title': 'Устранение неполадок режима TUI',
            'description': 'Проблемы режима интерфейса терминала',
            'related_commands': [
                {'command': 'cai --tui', 'description': 'Запустить CAI в режиме TUI'},
                {'command': '/env set CAI_TUI_MODE', 'description': 'Включить/выключить режим TUI'},
            ...
            'variables': {
                'CAI_TUI_MODE': 'Включить режим TUI',
                'CAI_TUI_MAX_LINES': 'Максимальное количество строк вывода',
                'CAI_TUI_MAX_RERENDERS_PER_SEC': 'Производительность рендеринга',
            },
            'cli_only_vars': [
                'CAI_API_HOST', 'CAI_API_PORT', 'CAI_API_WORKERS',
                'Эти переменные применяются только в режиме CLI',
            ],
            'tui_only_vars': [
                'CAI_TUI_MODE', 'CAI_TUI_STARTUP_YAML', 'CAI_TUI_SHARED_PROMPT',
                'CAI_TUI_MAX_LINES', 'CAI_TUI_MAX_RERENDERS_PER_SEC',
        ...
        'connection': {
            'title': 'Проблемы подключения/сети',
            'description': 'Устранение неполадок сетевого подключения',
            'related_commands': [
                {'command': '/settings status', 'description': 'Состояние системы'},
                {'command': '/settings validate', 'description': 'Проверка API ключей'},
                {'command': '/env set CAI_SKIP_NETWORK_CHECK', 'description': 'Пропустить проверки сети (не рекомендуется)'},
            ],
            'checks': [
                {
                    'check': 'Подключение к интернету',
                    'command': 'curl -I https://api.openai.com',
                    'fix': 'Проверьте настройки файрвола/прокси',
                },
                {
                    'check': 'Разрешение DNS',
                    'command': 'nslookup api.openai.com',
                    'fix': 'Попробуйте использовать 8.8.8.8 в качестве DNS',
                },
                {
                    'check': 'Настройка прокси',
                    'env_vars': ['HTTP_PROXY', 'HTTPS_PROXY', 'NO_PROXY'],
                    'fix': 'Установите соответствующие переменные среды прокси',
                },
            ],
            'skip_check': {
                'variable': 'CAI_SKIP_NETWORK_CHECK',
                'description': 'Пропустить проверки доступности сети (не рекомендуется)',
            },
        },
    },
}
